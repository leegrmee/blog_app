...
async def get_comment_handler(
    comment_id: int | None = Query(None, description="Filter comments by comment ID"),
    article_id: int | None = Query(None, description="Filter comments by article ID"),
    user_id: int | None = Query(None, description="Filter comments by user ID"),
