...
class CategoryService:
    ...
    async def get_categories_of_article(
        ...
        """특정 게시글의 카테고리 조회"""
        return await self.category_repository.get_categories_of_article(article_id)
    ...
    async def get_user_categories_and_articles(
        ...
        return await self.category_repository.get_user_categories_with_articles(user_id)
