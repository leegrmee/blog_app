...
class BaseCategoryToArticle(_PrismaModel):
    __prisma_model__: ClassVar[Literal['CategoryToArticle']] = 'CategoryToArticle'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.CategoryToArticleActions[_PrismaModelT]':
        from .client import get_client

        return actions.CategoryToArticleActions[_PrismaModelT](client or get_client(), cls)
