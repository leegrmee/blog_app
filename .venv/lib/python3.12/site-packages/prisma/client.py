...
SCHEMA_PATH = Path('/Users/garam/Desktop/project/BlogApp/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'darwin-arm64': '/Users/garam/.cache/prisma-python/binaries/5.17.0/393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/prisma/query-engine-darwin-arm64'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    category_to_article: 'actions.category_to_articleActions[models.category_to_article]'
    ...
    def __init__(
        ...
        *,
        ...
        self.category_to_article = actions.category_to_articleActions[models.category_to_article](self, models.category_to_article)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/Users/garam/Desktop/project/BlogApp/prisma/schema.prisma',
        }
...
class Batch:
    ...
    category_to_article: 'category_to_articleBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.category_to_article = category_to_articleBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class category_to_articleBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
    ...
    def create(
        ...
        self._batcher._add(
            method='create',
            model=models.category_to_article,
            arguments={
                'data': data,
                'include': include,
            },
